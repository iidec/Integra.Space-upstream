...
{/// <summary>
 ...
 /// </summary>
	public class SpaceQueueAdapterCache : IQueueAdapterCache
	{
		/// <summary>
		...
		public SpaceQueueAdapterCache(int cacheSize, Logger logger)
		{
			if (cacheSize <= 0)
		...
		{
			return caches.AddOrUpdate(queueId, (id) => new SpaceQueueCache(cacheSize, logger), (id, queueCache) => queueCache);
		}
