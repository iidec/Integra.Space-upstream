//-----------------------------------------------------------------------
// <copyright file="AlterSourceTypeFilter.cs" company="Integra.Space">
...
namespace Integra.Space.Pipeline.Filters
{
    ...
    /// Create source type
    /// </summary>
    internal class AlterSourceTypeFilter : CommandFilter
    {
        /// <inheritdoc />
        public override PipelineContext Execute(PipelineContext context)
        {
            SystemCommand command = context.CommandContext.Command;
            AlterSourceNode alterSourceCommand = (AlterSourceNode)command;
            if ((alterSourceCommand.ColumnsToAdd != null && alterSourceCommand.ColumnsToAdd.Count > 0) || (alterSourceCommand.ColumnsToRemove != null && alterSourceCommand.ColumnsToRemove.Count > 0))
            {
