namespace Integra.Space.Database
{
    ...
    public partial class Database
    {
        ...
        public Database()
        {
            ...
            DatabaseUsers1 = new HashSet<DatabaseUser>();
            Schemas = new HashSet<Schema>();
        }

        [Key]
        [Column("db_id", Order = 0)]
        ...
        [Column("owner_db_id")]
        public System.Guid owner_db_id { get; set; }
        ...
        [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Usage", "CA2227:CollectionPropertiesShouldBeReadOnly")]
        public virtual ICollection<DatabaseUser> DatabaseUsers1 { get; set; }
