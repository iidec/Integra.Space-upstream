namespace Integra.Space.Database
{
    ...
    [Table("space.dbroles_assigned_permissions_to_users")]
    public partial class DBRoleAssignedPermissionsToUser
    {
        [Key]
