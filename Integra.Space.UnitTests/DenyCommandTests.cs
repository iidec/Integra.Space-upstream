...
namespace Integra.Space.UnitTests
{
    ...
    public class DenyCommandTests
    {
        ...
        public void DenyAlterOnSource()
        {
            ...
            string databaseName = "Database1";
            string otherLogin = "LoginAux";
            string command = $"use Database1; create source {oldSourceName} (column1 int, column2 decimal, column3 string); grant connect on database {databaseName}, alter on source {oldSourceName} to user {userName}; deny connect on database {databaseName}, alter on source {oldSourceName} to user {userName}";
        ...
        public void DenyControlOnSource()
        {
            ...
            string userName = "UserAux";
            string databaseName = "Database1";
            string command = $"use {databaseName}; create source {oldSourceName} (column1 int, column2 decimal, column3 string); grant connect on database {databaseName}, control on source {oldSourceName} to user {userName}; deny control on source {oldSourceName} to user {userName}";
