CREATE TABLE [space].[logins_by_users] (
    ...
    CONSTRAINT [PK_logins_by_users] PRIMARY KEY CLUSTERED ([lg_id] ASC, [lg_srv_id] ASC, [dbusr_db_id] ASC, [dbusr_srv_id] ASC, [dbusr_id] ASC),
    ...
    CONSTRAINT [AK_logins_by_users_lg_id_lg_srv_id_dbusr_db_id] UNIQUE ([dbusr_db_id], [dbusr_srv_id], [dbusr_id])
);
